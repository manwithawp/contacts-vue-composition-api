  ...
  <div class="accordion-item accordion-item--contact mb-4">
    <div class="accordion-header" :id="'contactHeading-' + contactIdx">
      ...
      >
        ...
        <b-dropdown-item @click="addContact">Edit</b-dropdown-item>
        <b-dropdown-item @click="deleteContact(contact)">Delete</b-dropdown-item>
      </b-dropdown>
    </div>
    <b-collapse
...
function deleteContact(contact, contactIdx) {
  contactMethodsStore.contactRemoveModal = true;
  contactMethodsStore.contactCurrent = contact;
}
</script>
